// exportCsv.mjs — W31-I1: exportación de transacciones a CSV (función pura).
// Formato: fecha,descripcion,monto,moneda,cuenta,categoria — descripcion y
// categoria entre comillas dobles, escapando comillas internas (RFC 4180).
